...
Classification test instance will give a reference to const training object 
Next Step:
Implement weights container
...
\item add support for initializing weights to zero or random
