...
\item Improve About function so that Device is reported next to Algorithm name
...
\item Pass command queue to given module and some entry data/output buffer to execute given task
