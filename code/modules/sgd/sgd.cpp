 ...
 *
 */
StochasticGradientDescent::StochasticGradientDescent(const cl::Device* const pdevice) : m_about(StochasticGradientDescent::composeAboutString(pdevice) ), m_pdevice(pdevice), m_theta(0.1) 
{
    cl_int err;
